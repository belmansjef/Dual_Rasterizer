...
namespace dae
{
	...
	{
		/*Vector2 IntersectLines(const Vector2& v0, const Vector2& v1, const Vector2& p0, const Vector2& p1)
		{
			const float a0{ v1.y - v0.y };
			const float b0{ v0.x - v1.x };
			const float c0{ a0 * v0.x + b0 * v0.y };
			...
			const float x{ (b1 * c0 - b0 * c1) / det };
			const float y{ (a0 * c1 - a1 * c0) / det };
